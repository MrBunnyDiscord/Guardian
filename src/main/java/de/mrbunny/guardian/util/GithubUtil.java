...
import de.mrbunny.guardian.util.json.InstallationResponse;
...
public class GithubUtil {
    ...
    public static Optional<String> defaultInstallation(){
        return Optional.ofNullable (StartGuardian.cfg.github.defaultInstallation);
    }

    public static boolean forceDefault(){
        return StartGuardian.cfg.github.forceDefault;
    }
    ...
    static String getJWT(){
        ...
        if(jwt == null || jwtExpiry.isBefore (Instant.now ())){
            RSAPrivateKey key = getPrivateKey(StartGuardian.cfg.github.privateKey);
            ...
            jwt = JWT.create ()
                    .withIssuer (String.valueOf (StartGuardian.cfg.github.appId))
                    .withIssuedAt (now)
